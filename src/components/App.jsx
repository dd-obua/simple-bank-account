  ...
  switch (action.type) {
    ...
    case 'withdraw':
      return {
        ...
        balance:
          state.balance > 0 &&
          state.balance >= WITHDRAWAL_AMOUNT &&
  ...
  return (
    <div className="App">
      ...
      <p>
        <button
          onClick={() => {
            dispatch({ type: 'openAccount', payload: MIN_DEP_AMOUNT });
          }}
          disabled={isActive}
        >
          Open account
      ...
      <p>
        <button
          onClick={() => {
            dispatch({ type: 'deposit', payload: DEP_AMOUNT });
          }}
          disabled={!isActive}
        >
          Deposit 150
      ...
      <p>
        <button
          onClick={() => {
            dispatch({ type: 'payLoan', payload: LOAN_AMOUNT });
          }}
          disabled={!isActive || loan === 0}
        >
          Pay loan
